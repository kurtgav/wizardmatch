    ...
    <div className="min-h-screen flex items-center justify-center bg-retro-cream py-20">
      ...
      >
        ...
        <div className="bg-white border-8 border-navy shadow-[12px_12px_0_0_#1E3A8A] p-8 md:p-12 relative overflow-hidden">
          ...
          >
            <div className="w-20 h-20 bg-retro-pink border-4 border-navy mx-auto mb-4 flex items-center justify-center shadow-[4px_4px_0_0_#1E3A8A] p-3">
            ...
            <div className="flex items-center justify-center gap-2 text-cardinal-red">
              ...
              <span className="font-pixel text-xs">By Wizards</span>
            </div>
          </motion.div>
          ...
          <div className="bg-retro-lavender border-4 border-navy p-6 mb-8 shadow-[4px_4px_0_0_#1E3A8A]">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <p className="font-body text-sm text-navy">
                  <strong>Complete the survey</strong> to find your match
                </p>
              </li>
            </ul>
          </div>
          ...
          <div className="mt-8 text-center mb-4">
            <p className="font-body text-sm text-navy/80">
              New to Wizard Match?{' '}
              <Link href="/auth/signup" className="text-cardinal-red font-bold hover:underline font-pixel text-xs ml-1 inline-flex items-center gap-1">
          ...
          {/* Info */}
          <div className="mt-6 text-center border-t-2 border-navy/10 pt-4">
